    ...
    const todos = getAll()
        .then(data => {
            ...
            data.forEach((element, index) => {
                ...
                col7.innerHTML = `<a class="btn btn-success me-1 my-1" id="modificar" href="#" onclick="(${element.id})">Modificar</a> 
                <a class="btn btn-danger" id="modificar" href="#" onclick="eliminar(${element.id})">Eliminar</a>`;
...
document.getElementById("btnGuardar").addEventListener("click", (e) => {
    ...
    guardar(producto)
        ...
        .then(data => {
            ...
            var col7 = document.createElement("TD");
            col7.innerHTML =  `<a class="btn btn-success me-1 my-1" id="modificar" href="#" onclick="">Modificar</a> 
